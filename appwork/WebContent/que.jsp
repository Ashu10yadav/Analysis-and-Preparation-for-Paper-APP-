...
<sql:query var="topsel" dataSource="${mydb}">
	...
	<sql:update var="register" dataSource="${mydb}">
		insert into question(SemId,SCode,QNo,Question,op1,op2,op3,op4,Answer,Level,QType) values("${selseme}","${selsub}","${maxScode}","${param.addque}","${param.addop1}","${param.addop2}"
